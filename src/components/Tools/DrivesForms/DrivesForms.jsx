...
const DrivesForms = () => {
  ...
  const updateIndexedDB = async (id, imageUrl, modalAudioUrl, setMedicalFormData) => {
    try {
        ...
        // Update the fields
        if (record) {
            // Update the form data using setMedicalFormData
            setMedicalFormData(prevData => ({
                ...prevData,
                imageUrl: imageUrl || record.imageUrl,
                modalAudioUrl: modalAudioUrl || record.modalAudioUrl,
                // You can update other fields here similarly
            }));

            // Update record fields
            record.imageUrl = imageUrl || record.imageUrl;
            record.modalAudioUrl = modalAudioUrl || record.modalAudioUrl;
